...
class MenuFilters(models.Model):
    #name_filter = models.CharField(verbose_name= 'Nombre del Filtro', max_length=50, null=True, blank=True)
    #type_filter = models.BooleanField(verbose_name='Mostrar Filtro',default=False, help_text='Marque esta casilla para activar el filtro')
    version_filter = models.BooleanField(default=True, verbose_name='Versiones')
    config_filter = models.BooleanField(default=True, verbose_name='Configuraciones')
    db_filter = models.BooleanField(default=True, verbose_name='Base de Datos')
    docs_filter = models.BooleanField(default=True, verbose_name='Documentos')
    videos_filter = models.BooleanField(default=True, verbose_name='Videos')
    sp_http_oracle_filter = models.BooleanField(default=True, verbose_name='SP HTTP Oracle')
    sp_http_sql_filter = models.BooleanField(default=True, verbose_name='SP HTTP SQL server')
    postman_filter = models.BooleanField(default=True, verbose_name='Postman')

    class Meta:
        verbose_name_plural = "Filtros - Menu"
